...
const AboutPage = ({ data }) => (
  <section className="about">
    ...
    <p>I also own a localization company so if you are looking to explore new markets with your brand stop by <a href="https://www.kibo-int.com">my site</a> to see how I can meet your needs.</p>
    <ul>
