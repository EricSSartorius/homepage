  ...
  <div className="work">
    ...
    <ul>
      <li className="work-item">
        <Link to="/work-dev"><h3>Front-end Development And UI/UX Design</h3></Link>
      ...
      <li className="work-item">
        <Link to="/work-trans"><h3>Japanese and Korean Translation/Subtitling</h3></Link>
      ...
      <li className="work-item">
        <Link to="/work-model"><h3>Modeling</h3></Link>
      ...
      <li className="work-item">
        <Link to="/work-movement"><h3>Movement Coaching</h3></Link>
